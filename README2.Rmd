...
```{r tidy-data-r, cache = TRUE, echo = TRUE}
...
```{r inspect-r, echo = TRUE, results = FALSE, warning = FALSE, message = FALSE}
inspect_surv_data(
  data = surv_data,
  time = "time",
  event = "event",
...
```{asciicast inspect-a, echo = FALSE}
...
```{r get-KM-r, echo = TRUE, results = FALSE, warning = FALSE, message = FALSE}
km_check <- get_km(
  data = surv_data,
  time = "time",
  event = "event",
...
``` {r test-PH-r, echo = TRUE, results = FALSE, warning = FALSE, message = FALSE}
ph_check <- test_ph(
  data = surv_data,
  time = "time",
  event = "event",
...
```{asciicast test-PH-a, echo = FALSE}
surv_data <- easy_lung |>
  dplyr::mutate(
    time = time,
    event = status - 1,
...
``` {r fit-models-r, echo = TRUE, results = FALSE, warning = FALSE, message = FALSE}
...
```{asciicast fit-models-a, echo = FALSE}
surv_data <- easy_lung |>
  dplyr::mutate(
    time = time,
    event = status - 1,
...
``` {r plot-models-r, echo = TRUE, results = TRUE, warning = FALSE, message = FALSE}
...
```{asciicast plot-models-a, echo = FALSE}
surv_data <- easy_lung |>
  dplyr::mutate(
    time = time,
    event = status - 1,
