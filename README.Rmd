...
# # and printing in a single code block.
...
```{r get-KM, collapse = TRUE, fig.width=6, fig.height=5}
km_check <- get_km(
  data = surv_data,
  time = "time",
  event = "event",
...
```{r test-PH, collapse = TRUE, fig.width=6, fig.height=5}
ph_check <- test_ph(
  data = surv_data,
  time = "time",
  event = "event",
...
```{r fit-models, collapse = TRUE, fig.width=6, fig.height=5}
...
```{r plot-models, collapse = TRUE, fig.width=6, fig.height=5}
